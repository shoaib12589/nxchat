This fork of multistream includes [this patch](https://github.com/feross/multistream/pull/47) by [@ronag](https://github.com/ronag), and no other changes. This exists just to let Clinic.js use that patch. While the PR has not passed review yet, it is unlikely to make things worse in our specific case.
